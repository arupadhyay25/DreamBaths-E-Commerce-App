...
export const TopOffers = () => {
  ...
  return (
    <>
      ...
      <Advertise
        src="https://cdn-fsly.yottaa.net/5d669b394f1bbf7cb77826ae/www.bathandbodyworks.com/v~4b.219/on/demandware.static/-/Sites-BathAndBodyWorks-Library/default/dwd53d69dd/images/Christmas2022/b1g1candles_c1_6x1.gif?yocs=s_"
        alt="Banner"
        width="80%"
      />
        ...
        {offerData.map((e) => {
          return (
            <TopOfferDataDiv className="topoffer-data-div">
              <ProductImage
                className="topoffer-data-div-img"
                src={e.image}
                alt=""
              />
              <ProductTitle className="offer-box-div-p">{e.text}</ProductTitle>
              <ProductPrice className="offer-box-div-p1">
                {e.btext}
              </ProductPrice>
      ...
      <Advertise
        src="https://cdn-fsly.yottaa.net/5d669b394f1bbf7cb77826ae/www.bathandbodyworks.com/v~4b.219/on/demandware.static/-/Sites-BathAndBodyWorks-Library/default/dwd2941b82/images/Fall2022/boc-launch-prospects_sb_0.jpg?yocs=o_s_"
        alt="add"
      />
      <Info>
        ...
        <Detail>
          ...
          steals and the most need-right-now promotions we’ve got going on. From
          home fragrance favorites to body care loves, we definitely have
        ...
        <Detail>
          ...
          excited about our new body care collections (they’re basically joy in
          a bottle), and our latest candle and Wallflowers arrivals turn your
          home into a fragrance paradise. Trust us: with Bath & Body Works
          coupons, you actually can have it all!
        </Detail>

        <Detail>
          Another way we love using Bath & Body Works coupon codes? On gifts, of
          course! Check your calendar: if you have any birthdays or holidays on
          the horizon, this would be the perfect time to stock up on someone’s
          (or your) favorite fragrance. You could even score a few extra hand
          soaps or single wick candles to keep in your gift closet for the next
          celebration. (Incredible gifting strategy, go you!) And if you have a
          few common questions, let’s answer them here…
        </Detail>

        <Detail>
          How do you get Bath & Body Works coupons mailed to you? Just fill out
          our Mailing Address Update email form. Choose "Add me to your mailing
          list" as your Request Type and provide all relevant information. Then
        ...
        <Detail>
          Just fill out our Mailing Address Update email form. Choose "Add me to
          your mailing list" as your Request Type and provide all relevant
        ...
        <Detail>
          ...
          coupon sites can wait – this is the spot to check for the best deals.
          Hint, hint: now that you’ve seen our greatest deals shop our{" "}
          <span>
